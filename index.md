...
- **Connection to a printer** <span title="Can be switched off in the plugin settings" class="label label-success">switchable</span>
  ...
  - Used serial port & baudrate <span title="Up until OctoPrint 1.11.x" class="label label-info">up until 1.11.x</span>
  - Used printer connector <span title="Starting with OctoPrint 1.12.0" class="label label-info">1.12.0+</span>
  - Firmware name as reported by the printer (e.g. through `M115`)
